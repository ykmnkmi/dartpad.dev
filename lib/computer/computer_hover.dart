...
// From https://github.com/dart-lang/sdk/blob/stable/pkg/analysis_server/lib/src/computer/computer_hover.dart
...
final class DartUnitHoverComputer {
  ...
  static DartType? _getTypeOfDeclarationOrReference(Expression node) {
    if (node is SimpleIdentifier) {
      ...
      if (parent2 is AssignmentExpression && parent2.leftHandSide == parent) {
