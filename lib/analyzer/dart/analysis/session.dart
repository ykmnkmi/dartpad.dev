...
import 'package:dartpad/analyzer/dart/analysis/declared_variables.dart';
import 'package:dartpad/analyzer/dart/analysis/results.dart';
import 'package:dartpad/analyzer/dart/analysis/uri_converter.dart';
import 'package:dartpad/analyzer/dart/element/element.dart';
import 'package:dartpad/analyzer/exception/exception.dart';
...
abstract interface class AnalysisSession {
  ...
  Future<SomeResolvedLibraryResult> getResolvedLibraryByElement(LibraryElement element);
...
final class InconsistentAnalysisException extends AnalysisException {
  InconsistentAnalysisException() : super('Requested result might be inconsistent with previously returned results');
}
