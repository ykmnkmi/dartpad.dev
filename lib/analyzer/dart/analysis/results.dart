...
import 'package:dartpad/analyzer/dart/analysis/analysis_options.dart';
...
import 'package:dartpad/analyzer/dart/element/type_provider.dart';
import 'package:dartpad/analyzer/dart/element/type_system.dart';
...
abstract interface class AnalysisResult {
  /// Return the session used to compute this result.
  AnalysisSession get session;
}

/// An analysis result that includes the errors computed during analysis.
abstract interface class AnalysisResultWithErrors implements FileResult {
  /// The analysis errors that were computed during analysis.
  List<AnalysisError> get errors;
}

/// The type of [InvalidResult] returned when the given URI cannot be resolved.
final class CannotResolveUriResult
    implements InvalidResult, SomeLibraryElementResult, SomeParsedLibraryResult, SomeResolvedLibraryResult {}

/// The type of [InvalidResult] returned when the AnalysisContext has been
/// disposed.
final class DisposedAnalysisContextResult
    implements
        InvalidResult,
        SomeErrorsResult,
        SomeFileResult,
...
abstract interface class ElementDeclarationResult {
...
abstract interface class ErrorsResult implements SomeErrorsResult, AnalysisResultWithErrors {}
...
abstract interface class FileResult implements SomeFileResult, AnalysisResult {
...
abstract interface class InvalidResult {}

/// The result of building the element model for a library.
abstract interface class LibraryElementResult implements SomeLibraryElementResult {
...
final class NotElementOfThisSessionResult
    implements InvalidResult, SomeParsedLibraryResult, SomeResolvedLibraryResult {}

/// The type of [InvalidResult] returned when the given file is not a library,
/// but an augmentation of a library.
final class NotLibraryButAugmentationResult
    implements InvalidResult, SomeLibraryElementResult, SomeParsedLibraryResult, SomeResolvedLibraryResult {}

/// The type of [InvalidResult] returned when the given file is not a library,
/// but a part of a library.
final class NotLibraryButPartResult
    implements InvalidResult, SomeLibraryElementResult, SomeParsedLibraryResult, SomeResolvedLibraryResult {}
...
final class NotPathOfUriResult
    implements
        InvalidResult,
        SomeErrorsResult,
        SomeParsedLibraryResult,
...
abstract interface class ParsedLibraryResult implements SomeParsedLibraryResult, AnalysisResult {
...
abstract interface class ParsedUnitResult implements SomeParsedUnitResult, AnalysisResultWithErrors {
...
/// session.
abstract interface class ParseStringResult {
...
abstract interface class ResolvedLibraryResult implements ParsedLibraryResult, SomeResolvedLibraryResult {
...
abstract interface class ResolvedUnitResult implements ParsedUnitResult, SomeResolvedUnitResult {
...
abstract interface class SomeErrorsResult {}
...
abstract interface class SomeFileResult {}

/// The result of building the element model for a library.
///
/// There are existing implementations of this class.
/// [LibraryElementResult] represents a valid result.
abstract interface class SomeLibraryElementResult {}

/// The result of building parsed AST(s) for the whole library.
///
/// There are existing implementations of this class.
/// [ParsedLibraryResult] represents a valid result.
abstract interface class SomeParsedLibraryResult {}
...
abstract interface class SomeParsedUnitResult {}
...
abstract interface class SomeResolvedLibraryResult {}
...
abstract interface class SomeResolvedUnitResult {}

/// The result of building the element model for a single file.
///
/// There are existing implementations of this class.
/// [UnitElementResult] represents a valid result.
abstract interface class SomeUnitElementResult {}

/// The result of building the element model for a single file.
// TODO(scheglov): Stop implementing [FileResult].
abstract interface class UnitElementResult implements SomeUnitElementResult, FileResult {
...
final class UnspecifiedInvalidResult implements InvalidResult, SomeLibraryElementResult, SomeParsedLibraryResult {}
...
final class UriOfExternalLibraryResult implements InvalidResult, SomeParsedLibraryResult, SomeResolvedLibraryResult {}
