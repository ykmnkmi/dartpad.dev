...
import 'package:dartpad/analyzer/src/dart/analysis/context_locator.dart';
...
abstract interface class ContextLocator {
  ...
  factory ContextLocator({required ResourceProvider resourceProvider}) = ContextLocatorImpl;
