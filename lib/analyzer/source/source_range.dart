...
final class SourceRange {
  ...
  bool operator ==(Object other) {
    return other is SourceRange && other.offset == offset && other.length == length;
  }
  ...
  SourceRange getExpanded(int delta) {
    return SourceRange(offset - delta, delta + length + delta);
  }
  ...
  SourceRange getMoveEnd(int delta) {
    return SourceRange(offset, length + delta);
  }
  ...
  SourceRange getTranslated(int delta) {
    return SourceRange(offset + delta, length);
  }
  ...
  SourceRange getUnion(SourceRange otherRange) {
    ...
    int newEnd = math.max(offset + length, otherRange.offset + otherRange.length);
  ...
  bool startsIn(SourceRange otherRange) {
