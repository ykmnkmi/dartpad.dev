...
base class AnalysisException implements Exception {
  ...
  String toString() {
    ...
    CaughtException? cause = this.cause;
...
base class CaughtException implements Exception {
  /// Initialize a newly created caught exception to have the given [exception]
  /// and [stackTrace].
  CaughtException(Object exception, StackTrace stackTrace) : this.withMessage(null, exception, stackTrace);
...
/// reporting.
final class SilentException extends CaughtException {
  SilentException(String super.message, super.exception, super.stackTrace) : super.withMessage();
