...
export 'package:dartpad/analyzer/src/file_system/file_system.dart';

/// [File]s are leaf [Resource]s which contain data.
abstract interface class File implements Resource {
...
base class FileSystemException implements Exception {
...
abstract interface class Folder implements Resource {
...
final class ResourceWatcher {
  ResourceWatcher(this.changes, Future<void> Function() ready) : _ready = ready;
