...
/// representation.
final class AnalyzerError implements Exception {
...
final class AnalyzerErrorGroup implements Exception {
  AnalyzerErrorGroup(Iterable<AnalyzerError> errors) : _errors = errors.toList();
  ...
  AnalyzerErrorGroup.fromAnalysisErrors(Iterable<AnalysisError> errors)
      : this(errors.map<AnalyzerError>(AnalyzerError.new));

  /// The errors in this collection.
  List<AnalyzerError> get errors {
    return UnmodifiableListView<AnalyzerError>(_errors);
  }
