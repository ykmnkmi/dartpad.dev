...
import 'package:analyzer_js/dart/analysis/utilities.dart';
...
import 'package:analyzer_js/src/summary/format.dart' as idl;
import 'package:analyzer_js/src/summary/idl.dart' as idl;
  ...
  void _buildFileDeclarations(CompilationUnit unit) {
    ...
    for (var node in unit.declarations) {
      ...
      if (node is ClassDeclaration) {
        ...
        } else if (type is NamedType && type.name2.lexeme.isNotEmpty) {
          addDeclaration(
            isDeprecated: isDeprecated,
