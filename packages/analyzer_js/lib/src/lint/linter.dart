...
import 'package:analyzer_js/file_system/file_system.dart' as fs;
import 'package:analyzer_js/file_system/glob.dart';
...
import 'package:analyzer_js/src/dart/constant/potentially_constant.dart';
import 'package:analyzer_js/src/dart/constant/utilities.dart';
import 'package:analyzer_js/src/dart/constant/value.dart';
...
import 'package:analyzer_js/src/generated/source.dart' show LineInfo;
import 'package:analyzer_js/src/lint/analysis.dart';
import 'package:analyzer_js/src/lint/config.dart';
import 'package:analyzer_js/src/lint/linter_visitor.dart' show NodeLintRegistry;
import 'package:analyzer_js/src/lint/pub.dart';
import 'package:analyzer_js/src/lint/registry.dart';
import 'package:analyzer_js/src/lint/state.dart';
import 'package:analyzer_js/src/lint/util.dart';
import 'package:analyzer_js/src/services/lint.dart' show Linter;
import 'package:analyzer_js/src/workspace/workspace.dart';
import 'package:path/path.dart' as p;

export 'package:analyzer_js/src/lint/linter_visitor.dart' show NodeLintRegistry;
export 'package:analyzer_js/src/lint/state.dart' show dart3, State;
...
class DartLinter implements AnalysisErrorListener {
  ...
  Future<Iterable<AnalysisErrorInfo>> lintFiles(List<fs.File> files) async {
    ...
    for (Linter lint in options.enabledLints) {
      if (lint is LintRule) {
        ...
        if (visitor != null) {
          ...
          if (sourceUrl != null) {
            var source = createSource(resourceProvider, sourceUrl);
  ...
  Iterable<AnalysisErrorInfo> _lintPubspecFile(fs.File sourceFile) =>
      lintPubspecSource(
        contents: sourceFile.readAsStringSync(),
        sourcePath:
            options.resourceProvider.pathContext.normalize(sourceFile.path),
        resourceProvider: sourceFile.provider,
      );
}
...
class LinterOptions extends DriverOptions {
  ...
  LintFilter? filter;
  late fs.ResourceProvider resourceProvider;
