...
import 'package:analyzer_js/src/source/package_map_resolver.dart';
...
class PackageBuildWorkspace extends Workspace implements PubWorkspace {
  ...
  PackageBuildWorkspace._(
    ...
    _theOnlyPackage = PackageBuildWorkspacePackage(root, this, provider);
  }
...
class PackageBuildWorkspacePackage extends WorkspacePackage
  ...
  PackageBuildWorkspacePackage(
    ...
    ResourceProvider resourceProvider,
          ...
          if (content != null) {
            return Pubspec.parse(content, resourceProvider: resourceProvider);
          }
        })();
